...
urlpatterns = [
    ...
    # Daily screenshot analytics API (NEW)
    path('analytics/daily-screenshots/', api_views.daily_screenshot_analytics_api, name='api_daily_screenshot_analytics'),
    
    # Date-wise screenshot analytics API (NEW) - For date-wise breakdown
    path('analytics/date-wise-screenshots/', api_views.date_wise_screenshot_analytics_api, name='api_date_wise_screenshot_analytics'),

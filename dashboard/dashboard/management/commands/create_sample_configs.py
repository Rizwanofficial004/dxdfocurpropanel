...
class Command(BaseCommand):
    help = 'Create sample configuration settings for the three types: upload, database, aws'

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('Creating sample configuration settings...'))
        ...
        self.stdout.write(f"✅ Upload Configuration: {'Created' if created else 'Already exists'}")
        ...
        self.stdout.write(f"✅ Database Configuration: {'Created' if created else 'Already exists'}")
        ...
        self.stdout.write(f"✅ AWS Configuration: {'Created' if created else 'Already exists'}")
        ...
        self.stdout.write(f"✅ Development Upload Configuration: {'Created' if created else 'Already exists'}")
        ...
        self.stdout.write(f"✅ Test Database Configuration: {'Created' if created else 'Already exists'}")
        ...
        self.stdout.write(f"✅ Development AWS Configuration: {'Created' if created else 'Already exists'}")

        self.stdout.write(self.style.SUCCESS('\n🎉 Sample configuration data creation completed!'))
        self.stdout.write(f"\n📋 Summary:")
        self.stdout.write(f"   • Upload Configurations: {ConfigurationSettings.objects.filter(type='upload').count()}")
        self.stdout.write(f"   • Database Configurations: {ConfigurationSettings.objects.filter(type='database').count()}")
        self.stdout.write(f"   • AWS Configurations: {ConfigurationSettings.objects.filter(type='aws').count()}")
        self.stdout.write(f"   • Total Configurations: {ConfigurationSettings.objects.count()}")

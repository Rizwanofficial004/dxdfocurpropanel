...
const translations = {
  ...
  activityStreamHelpShort: 'Shows a quick overview of recent user activity and highlighted days. Select a date or user to load screenshots for that period.',
    ...
    quickViewTooltip: 'Effortlessly access a comprehensive report to quickly view the current status of all your organization\'s employees in a single glance.',
    loadingEmployeeData: 'Loading employee data for',
    successfullyLoaded: 'Successfully loaded',
    employeesFor: 'employees for',
    noDataFound: 'No data found for',
    tryDifferentDate: 'Try selecting a different date to view employee data',
    atWork: 'AT WORK',
    available: 'AVAILABLE',
    inMeeting: 'IN MEETING',
    holiday: 'HOLIDAY',
    weekOff: 'WEEK OFF',
    inactive: 'Inactive',
    totalTimeLogged: 'Total time employee has been logged into the system',
    timeActivelyWorking: 'Time actively spent working',
    timeProductiveActivities: 'Time spent on productive activities',
    timeMeetings: 'Time spent in meetings',
    
    // Live Tracking Page
    liveTrackingTitle: 'LIVE TRACKING',
    liveTrackingHelp: 'Access real-time employee status updates and instant insights through easy screenshot viewing.',
    chooseTeam: 'Choose a team',
    allTeams: 'All Teams',
    loadingTeams: 'Loading teams...',
    dateLabel: 'Date:',
    loadingScreenshotsData: 'Loading screenshots data...',
    processingFiles: 'Processing',
    filesAcross: 'files across',
    users: 'users',
    mayTake: 'This may take 30-60 seconds for large datasets.',
    noUsersDataAvailable: 'No users data available',
    itemsPerPage: 'Items per page:',
    
    // Dashboard Page
    welcomeModalTitle: 'Welcome to DXD Focus',
    ...
    // Error Messages
    requestTimeout: 'Request timeout. The S3 API is processing a large dataset. Please try again or contact support if this persists.',
    s3AccessDenied: 'S3 Access Denied. Check AWS credentials.',
    s3BucketNotFound: 'S3 Bucket Not Found. Bucket may not exist or be accessible.',
    serverError: 'Server Error. S3 service may be experiencing issues.',
    networkError: 'Network error: Unable to connect to the API. Please check your internet connection.',
    ...
    realTimeActivityStream: 'Real Time Activity Stream',
    searchEmployee: 'Search Employee',
    searchUsersByName: 'Search users by name or email (All users shown below) ↓',
    searchResultsFor: 'Search Results for',
    found: 'found',
    availableUsers: 'Available Users',
    loadingUsers: 'Loading users...',
    noUsersWithScreenshots: 'No users with screenshots found',
    loadUsers: 'Load Users',
    clickToLoadData: 'Click to load data',
    loadingScreenshots: 'Loading screenshots...',
    noScreenshotsFound: 'No screenshots found for this period',
    refresh: 'Refresh',
    allUsersActivity: 'All Users Activity',
    usersWithActivity: 'users with activity found',
    screenshots: 'screenshots',
    viewAll: 'View All',
    viewAllScreenshots: 'View All Screenshots',
    searchingFor: 'Searching for',
    retrySearch: 'Retry Search',
    selectUserToView: 'Select a user from the list to view their screenshots',
    welcomeActivityStream: 'Welcome to the Activity Stream',
    clickSearchBox: 'Click the search box above to see all available users',
    typeNameOrEmail: 'Type a name or email to search specific users',
    selectAnyUser: 'Select any user to view their detailed activity and screenshots',
    perPage: 'per page',
    screenshotsPerPage: 'Screenshots per page:',
    showingOf: 'Showing',
    of: 'of',
    totalScreenshots: 'total screenshots',
    noScreenshotsForPeriod: 'No screenshots found for the selected period',
    page: 'Page',
    first: 'First',
    previous: 'Previous',
    next: 'Next',
  ...
  tr: {
    ...
    // Common
      oldScreenshotsHeader: 'Real Time Activity Stream',
      oldScreenshotsSubheader: 'Monitor live screenshots and user activity',
      ...
      screenshotsToday: 'Screenshots Today',
      liveActivityFeed: 'Live Activity Feed',
      live: 'LIVE',
      calendarDays: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
      noScreenshots: 'No screenshots available',
      screenshotsWillAppear: 'Screenshots will appear here as users are active',
    oldScreenshots: 'Old Screenshots',
    documentation: 'Documentation',
    employees: 'Employees',
    home: 'Ana Sayfa',
      oldScreenshotsHeader: 'Gerçek Zamanlı Aktivite Akışı',
      oldScreenshotsSubheader: 'Canlı ekran görüntülerini ve kullanıcı aktivitelerini izleyin',
      quickFilters: 'Hızlı Filtreler',
      year: 'Yıl',
      month: 'Ay',
      userSearch: 'Kullanıcı Arama',
      searchUsers: 'Kullanıcıları ara...',
      liveStatistics: 'Canlı İstatistikler',
      screenshotsToday: 'Bugünkü Ekran Görüntüleri',
      liveActivityFeed: 'Canlı Aktivite Akışı',
      live: 'CANLI',
      calendarDays: ['Paz', 'Pzt', 'Sal', 'Çar', 'Per', 'Cum', 'Cmt'],
      noScreenshots: 'Hiç ekran görüntüsü yok',
      screenshotsWillAppear: 'Kullanıcılar aktif oldukça ekran görüntüleri burada görünecek',
    dashboard: 'Kontrol Paneli',
    liveTracking: 'Canlı İzleme',
    quickView: 'Hızlı Görünüm',
    oldScreenshots: 'Eski Ekran Görüntüleri',
  ...
  activityStreamHelpShort: 'Son kullanıcı aktivitelerinin ve vurgulanan günlerin hızlı bir özetini gösterir. O döneme ait ekran görüntülerini yüklemek için bir tarih veya kullanıcı seçin.',
    ...
    // Employee Reports Page
    newEmployee: 'YENİ ÇALIŞAN',
    name: 'İSİM',
    designation: 'ÜNVAN',
    screenshotInterval: 'EKRAN GÖRÜNTÜSÜ ARALIĞI',
    lastLogin: 'SON GİRİŞ',
    actions: 'İŞLEMLER',
    viewReport: 'RAPORU GÖRÜNTÜLE',
    loadingEmployees: 'Çalışanlar yükleniyor...',
    ...
    // Quick View Page
    quickViewTitle: 'HIZLI GÖRÜNÜM',
    quickViewTooltip: 'Organizasyonunuzdaki tüm çalışanların mevcut durumunu tek bakışta hızlıca görüntülemek için kapsamlı bir rapora zahmetsizce erişin.',
    loadingEmployeeData: 'Çalışan verileri yükleniyor:',
    successfullyLoaded: 'Başarıyla yüklendi',
    employeesFor: 'çalışan:',
    noDataFound: 'Veri bulunamadı:',
    tryDifferentDate: 'Çalışan verilerini görüntülemek için farklı bir tarih seçmeyi deneyin',
    atWork: 'İŞTE',
    available: 'MÜSAİT',
    inMeeting: 'TOPLANTIDA',
    holiday: 'TATİL',
    weekOff: 'HAFTA SONU',
    inactive: 'Pasif',
    totalTimeLogged: 'Çalışanın sisteme giriş yaptığı toplam süre',
    timeActivelyWorking: 'Aktif olarak çalışılan süre',
    timeProductiveActivities: 'Üretken aktivitelerde harcanan süre',
    timeMeetings: 'Toplantılarda geçirilen süre',
    
    // Live Tracking Page
    liveTrackingTitle: 'CANLI İZLEME',
    liveTrackingHelp: 'Kolay ekran görüntüsü görüntüleme yoluyla gerçek zamanlı çalışan durumu güncellemelerine ve anlık içgörülere erişin.',
    chooseTeam: 'Bir takım seçin',
    allTeams: 'Tüm Takımlar',
    loadingTeams: 'Takımlar yükleniyor...',
    dateLabel: 'Tarih:',
    loadingScreenshotsData: 'Ekran görüntüsü verileri yükleniyor...',
    processingFiles: 'İşleniyor',
    filesAcross: 'dosya',
    users: 'kullanıcı',
    mayTake: 'Büyük veri setleri için 30-60 saniye sürebilir.',
    noUsersDataAvailable: 'Kullanıcı verisi mevcut değil',
    itemsPerPage: 'Sayfa başına öğe:',
    
    // Dashboard Page
    welcomeModalTitle: 'DXD Focus\'a Hoş Geldiniz',
    
    // Common Status
    atWorkStatus: 'Aktif',
    availableStatus: 'Müsait',
    inMeetingStatus: 'Toplantıda',
    holidayStatus: 'Tatil',
    weekOffStatus: 'Hafta Sonu',
    offStatus: 'KAPALI',
    ...
    // Error Messages
    requestTimeout: 'İstek zaman aşımı. S3 API büyük bir veri setini işliyor. Lütfen tekrar deneyin veya devam ederse destek ile iletişime geçin.',
    s3AccessDenied: 'S3 Erişim Reddedildi. AWS kimlik bilgilerini kontrol edin.',
    s3BucketNotFound: 'S3 Bucket Bulunamadı. Bucket mevcut olmayabilir veya erişilebilir değildir.',
    serverError: 'Sunucu Hatası. S3 hizmeti sorunlar yaşıyor olabilir.',
    networkError: 'Ağ hatası: API\'ye bağlanılamıyor. Lütfen internet bağlantınızı kontrol edin.',
    ...
    realTimeActivityStream: 'Gerçek Zamanlı Aktivite Akışı',
    searchEmployee: 'Çalışan Ara',
    searchUsersByName: 'Kullanıcıları ad veya e-posta ile arayın (Tüm kullanıcılar aşağıda gösterilir) ↓',
    searchResultsFor: 'Arama sonuçları',
    found: 'bulundu',
    availableUsers: 'Mevcut Kullanıcılar',
    loadingUsers: 'Kullanıcılar yükleniyor...',
    noUsersWithScreenshots: 'Ekran görüntüsü olan kullanıcı bulunamadı',
    loadUsers: 'Kullanıcıları Yükle',
    clickToLoadData: 'Veri yüklemek için tıklayın',
    loadingScreenshots: 'Ekran görüntüleri yükleniyor...',
    noScreenshotsFound: 'Bu dönem için ekran görüntüsü bulunamadı',
    refresh: 'Yenile',
    allUsersActivity: 'Tüm Kullanıcı Aktiviteleri',
    usersWithActivity: 'aktiviteli kullanıcı bulundu',
    screenshots: 'ekran görüntüsü',
    viewAll: 'Tümünü Görüntüle',
    viewAllScreenshots: 'Tüm Ekran Görüntülerini Görüntüle',
    searchingFor: 'Aranan',
    retrySearch: 'Aramayı Tekrar Dene',
    selectUserToView: 'Ekran görüntülerini görüntülemek için listeden bir kullanıcı seçin',
    welcomeActivityStream: 'Aktivite Akışına Hoş Geldiniz',
    clickSearchBox: 'Tüm mevcut kullanıcıları görmek için yukarıdaki arama kutusuna tıklayın',
    typeNameOrEmail: 'Belirli kullanıcıları aramak için bir ad veya e-posta yazın',
    selectAnyUser: 'Detaylı aktivite ve ekran görüntülerini görüntülemek için herhangi bir kullanıcı seçin',
    perPage: 'sayfa başına',
    screenshotsPerPage: 'Sayfa başına ekran görüntüsü:',
    showingOf: 'Gösterilen',
    of: '/',
    totalScreenshots: 'toplam ekran görüntüsü',
    noScreenshotsForPeriod: 'Seçili dönem için ekran görüntüsü bulunamadı',
    page: 'Sayfa',
    first: 'İlk',
    previous: 'Önceki',
    next: 'Sonraki',
    ...
    results: 'Sonuçlar',
    trySearchingFor: 'Şunu aramayı deneyin:',
  }
};

...
const ChatIcon = ({ theme }) => (
  <svg 
    fill={theme?.mode === 'dark' ? '#e2e8f0' : '#475569'} 
    width="40" 
    height="40" 
...
const DownloadIcon = ({ theme }) => (
  <svg 
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M12 7L12 14M12 14L15 11M12 14L9 11" stroke={theme?.mode === 'dark' ? '#e2e8f0' : '#475569'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M16 17H12H8" stroke={theme?.mode === 'dark' ? '#e2e8f0' : '#475569'} strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C21.5093 4.43821 21.8356 5.80655 21.9449 8" stroke={theme?.mode === 'dark' ? '#e2e8f0' : '#475569'} strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
    ...
    <SidebarContainer $isCollapsed={isCollapsed}>
      ...
      <BottomSection $isCollapsed={isCollapsed}>
        <BottomItem style={{ width: isCollapsed ? '100%' : 'auto', padding: isCollapsed ? '8px 6px' : undefined }}>
          <BottomIcon><ChatIcon theme={theme} /></BottomIcon>
        ...
        <BottomItem onClick={() => window.open('https://wa.me/905488612323', '_blank') } style={{ width: isCollapsed ? '100%' : 'auto', padding: isCollapsed ? '8px 6px' : undefined }}>
          <BottomIcon><PhoneIcon theme={theme} /></BottomIcon>
        ...
        <BottomItem onClick={() => window.open('https://drive.google.com/drive/folders/1MVYaOcSkV97iNxzMFJm8dtLeJ2R03NcJ?usp=drive_link', '_blank') } style={{ width: isCollapsed ? '100%' : 'auto', padding: isCollapsed ? '8px 6px' : undefined }}>
          <BottomIcon><DownloadIcon theme={theme} /></BottomIcon>
